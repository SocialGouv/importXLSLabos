...
export default () => {
  ...
  if (done) {
    return (
      <AuthWrapper>
        ...
        <HowReset>Le lien de récupération du mot de passe a été envoyé à votre adresse e-mail, veuillez vérifier votre boîte de réception et suivez le lien pour réinitialiser votre mot de passe.</HowReset>
      </AuthWrapper>
    );
  }
  ...
  return (
    <AuthWrapper>
      <Title>Mot de passe oublié</Title>
      <HowReset>Entrez votre adresse e-mail ci-dessous pour recevoir le lien de réinitialisation du mot de passe.</HowReset>
      <Formik
        initialValues={{ email: "" }}
