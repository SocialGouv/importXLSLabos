...
export default () => {
  ...
  return (
    <AuthWrapper>
      <Title>Se connecter à l'import ARS COVID 19 IDF</Title>
      {user && <Redirect to="/" />}
      <Formik
        ...
        onSubmit={async (values, actions) => {
          try {
            ...
            toastr.error("Mauvaise combinaison email/mdp", e.code);
          }
        ...
        {({ values, errors, isSubmitting, handleChange, handleSubmit }) => {
          return (
            <form onSubmit={handleSubmit}>
              ...
              <Account>
                Si vous n'avez pas de compte, vous pouvez contacter <a href="mailto:bastien.mezerette@ars.sante.fr">bastien.mezerette@ars.sante.fr</a>.
              </Account>
            </form>
          );
        }}
